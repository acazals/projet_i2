# Generated by Django 2.2.28 on 2024-11-15 14:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('etat', models.CharField(blank=True, max_length=20)),
                ('type', models.CharField(blank=True, max_length=20)),
                ('team', models.CharField(blank=True, max_length=20)),
                ('photo', models.CharField(blank=True, max_length=200)),
                ('lieu', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='blog.Equipement')),
            ],
        ),
    ]
